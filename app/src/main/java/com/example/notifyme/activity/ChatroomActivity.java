...
import com.example.notifyme.fragments.UserListFragment;
import com.example.notifyme.model.UserClient;
import com.example.notifyme.adapters.ChatMessageRecyclerAdapter;
import com.example.notifyme.model.ChatMessage;
        ...
        View.OnClickListener
{
    ...
    private void getUserLocation(User user) {
        DocumentReference otherUserLocRef = mDb.collection(getString(R.string.collection_user_locations))
                .document(FirebaseAuth.getInstance().getUid());
        otherUserLocRef.get().addOnCompleteListener(new OnCompleteListener<DocumentSnapshot>() {
            @Override
    ...
    private void inflateMapFragment() {
        ...
        FragmentTransaction transaction = getSupportFragmentManager().beginTransaction();
        transaction.setCustomAnimations(R.anim.slide_in_up, R.anim.slide_out_up);
        transaction.replace(R.id.user_list_container, mapFragment, getString(R.string.fragment_map));
